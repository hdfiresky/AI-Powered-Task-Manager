...
// You would switch to a relative URL so the browser calls the same domain.
// const BACKEND_API_URL = 'api/breakdown-task'; // e.g., /ai-powered-task-manager/api/breakdown-task
